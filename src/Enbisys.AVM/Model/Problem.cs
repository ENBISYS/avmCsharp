...
namespace Enbisys.AVM.Model
{
    ...
    public partial class Problem :  IEquatable<Problem>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="type">A relative URI reference that identifies the problem type. When dereferenced, it SHOULD provide human-readable documentation for the problem type (e.g. using HTML). (default to &quot;about:blank&quot;).</param>
        /// <param name="title">A short, summary of the problem type. Written in english and readable for engineers (usually not suited for non technical stakeholders and not localized).</param>
        ...
        /// </summary>
        /// <value>A relative URI reference that identifies the problem type. When dereferenced, it SHOULD provide human-readable documentation for the problem type (e.g. using HTML).</value>
        ...
        /// </summary>
        /// <value>A short, summary of the problem type. Written in english and readable for engineers (usually not suited for non technical stakeholders and not localized)</value>
